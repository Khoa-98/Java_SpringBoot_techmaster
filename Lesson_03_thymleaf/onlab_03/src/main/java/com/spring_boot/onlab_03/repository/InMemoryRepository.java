...
public class InMemoryRepository {
    ...
    private ConcurrentHashMap<String , Book> book2;
    ...
    public InMemoryRepository() {
        ...
        books = new ArrayList<>(List.of(
                new Book("cuon theo chieu gio", "khong biet")));

        book2 = new ConcurrentHashMap<>();
        book2.put("abc", new Book("abc", "noname"));
    ...
    public ConcurrentHashMap<String, Book> getBook2() {
        return book2;
    }

    public void setBook2(ConcurrentHashMap<String, Book> book2) {
        this.book2 = book2;
    }
